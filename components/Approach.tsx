  ...
  return (
    <section className="w-full py-20">
      <h1 className="heading">
        My <span className="text-[#52b788]">approach</span>
      </h1>
    ...
    <div>
      <button className="relative inline-flex overflow-hidden rounded-full p-[1px] ">
        <span
         ...
         bg-[conic-gradient(from_90deg_at_50%_50%,#F26A1B_0%,#52b788_20%,#F26A1B_100%)]"
        />
        <span
          className="inline-flex h-full w-full cursor-pointer items-center 
        justify-center rounded-full bg-slate-950 px-5 py-2 text-[#52b788] backdrop-blur-3xl font-bold text-2xl"
        >
          {order}
        </span>
      </button>
